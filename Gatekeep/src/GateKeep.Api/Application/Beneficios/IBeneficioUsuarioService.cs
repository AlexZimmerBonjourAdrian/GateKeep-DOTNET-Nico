...
public interface IBeneficioUsuarioService
{
    ...
    Task<IEnumerable<BeneficioUsuarioDto>> ObtenerBeneficiosCanjeadosPorUsuarioAsync(long usuarioId);
    ...
    Task<BeneficioUsuarioDto> CanjearBeneficioAsync(long usuarioId, long beneficioId, string puntoControl);
}
